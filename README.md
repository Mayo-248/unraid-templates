...
Sometimes, new or beta software (like the TeamSpeak 6 Beta Server) is not yet available in the official Unraid Community Applications store. I created this repository to provide easy, "one-click" installation templates for the community. By sharing these XML files, I want to save other Unraid users the hassle of configuring ports, paths, and variables completely from scratch.
